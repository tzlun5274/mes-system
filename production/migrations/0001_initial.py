    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "workorder_id",
                    models.CharField(max_length=50, verbose_name="工單ID"),
                ),
                ("product_id", models.CharField(max_length=50, verbose_name="產品ID")),
                (
                    "production_line_id",
                    models.CharField(max_length=50, verbose_name="產線ID"),
                ),
                (
                    "production_line_name",
                    models.CharField(max_length=100, verbose_name="產線名稱"),
                ),
                ...
                (
                    "actual_quantity",
                    models.IntegerField(default=0, verbose_name="實際數量"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "line_type_id",
                    models.CharField(max_length=50, verbose_name="產線類型ID"),
                ),
                (
                    "line_type_name",
                    models.CharField(max_length=100, verbose_name="產線類型名稱"),
                ),
                (
                    "description",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "current_speed",
                    models.FloatField(default=0, verbose_name="當前速度"),
                ),
