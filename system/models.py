...
class UserPermissionDetail(models.Model):
    ...
    can_operator_reporting = models.BooleanField(default=True, verbose_name="可作業員報工")
...
class UserWorkPermission(models.Model):
    ...
    can_operator_reporting = models.BooleanField(default=True, verbose_name="可進行作業員報工")
