        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unit_id",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="單位ID"
                    ),
                ),
                (
                    "unit_name",
                    models.CharField(
                        blank=True, max_length=100, null=True, verbose_name="單位名稱"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "event_related_id",
                    models.CharField(
                        blank=True, max_length=50, null=True, verbose_name="關聯事件ID"
                    ),
                ),
                (
                    "event_related_title",
