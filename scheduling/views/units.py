        ...
        unit_list = [
            {
                ...
                'lunch_start': unit.lunch_start.strftime('%H:%M:%S') if unit.lunch_start else None,
                'lunch_end': unit.lunch_end.strftime('%H:%M:%S') if unit.lunch_end else None,
                'overtime_start': unit.overtime_start.strftime('%H:%M:%S') if unit.overtime_start else None,
                'overtime_end': unit.overtime_end.strftime('%H:%M:%S') if unit.overtime_end else None,
            }
            for unit in units
        ]
