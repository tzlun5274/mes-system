...
urlpatterns = [
    ...
    path(
        "update_unit_work_hours/",
        views.update_unit_work_hours,
        name="update_unit_work_hours",
    ),
    path(
        "update_order_schedule/",
        views.update_order_schedule,
        name="update_order_schedule",
    ),
    ...
    path(
        ...
        views.update_safety_settings,
        name="update_safety_settings",
    ),
    path(
        "update_process_interval/",
        views.update_process_interval,
        name="update_process_interval",
    ),
    path("schedule_management/", views.schedule_management, name="schedule_management"),
    path(
        "product_capacity_setting/",
        views.product_capacity_setting,
        name="product_capacity_setting",
    ),
    ...
    path(
        "hybrid/preview/", hybrid_scheduling_preview, name="hybrid_scheduling_preview"
    ),
    ...
    path(
        ...
        views.delete_all_production_events,
        name="delete_all_production_events",
    ),
    path(
        "delete_order_production_events/",
        views.delete_order_production_events,
        name="delete_order_production_events",
    ),
    ...
    path(
        ...
        get_scheduling_progress,
        name="get_scheduling_progress",
    ),
    path(
        "api/scheduling-parameters/",
        get_scheduling_parameters,
