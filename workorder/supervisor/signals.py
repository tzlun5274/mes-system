...
@receiver(post_save, sender=BackupOperatorSupplementReport)
...
@receiver(post_save, sender=BackupSMTSupplementReport)
...
@receiver(post_delete, sender=BackupOperatorSupplementReport)
...
@receiver(post_delete, sender=BackupSMTSupplementReport)
