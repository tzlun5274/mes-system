...
# @receiver(post_save, sender=# def operator_report_saved(sender, instance, created, **kwargs):
#     """
#     作業員報工記錄保存後的信號處理
#     """
#     if created:
...
# @receiver(post_save, sender=# def smt_report_saved(sender, instance, created, **kwargs):
#     """
#     SMT補登報工記錄保存後的信號處理
#     """
#     if created:
...
# @receiver(post_delete, sender=# def operator_report_deleted(sender, instance, **kwargs):
#     """
#     作業員報工記錄刪除後的信號處理
#     """
#     logger.info(f"刪除作業員報工記錄: {instance.id}")

# @receiver(post_delete, sender=# def smt_report_deleted(sender, instance, **kwargs):
#     """
#     SMT補登報工記錄刪除後的信號處理
#     """
