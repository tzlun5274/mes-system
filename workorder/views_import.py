...
def download_smt_import_template(request):
    ...
    try:
        ...
        # 範例資料
        example_data = [
            ['SMT-001', '10', '2025-01-15', '08:00', '12:00', 'WO-10-202501001', 'PROD-001', 'SMT', '', 100, 2, '正常生產', ''],
            ['SMT-002', '10', '2025/01/15', '13:00', '17:00', 'WO-10-202501001', 'PROD-001', 'SMT', '', 95, 5, '設備調整', '設備故障30分鐘'],
