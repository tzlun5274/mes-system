...
def smt_report_index(request):
    ...
    """
    from equip.models import Equipment
    from workorder.models import CompletedProductionReport as SMTSupplementReport
    from .services.statistics_service import StatisticsService
    ...
    try:
        ...
        for report_data in reports_data:
            try:
                ...
                # 建立報工記錄
                report =                     operator_id=report_data['operator_id'],
...
def supervisor_index(request):
    """主管功能首頁"""
    # 統計資料
    total_operator_reports =     pending_operator_reports =     approved_operator_reports =     
    total_smt_reports = SMTSupplementReport.objects.count()
...
def submit_operator_report(request):
    ...
    try:
        ...
        # 建立報工記錄
        report =             operator_id=data['operator_id'],
