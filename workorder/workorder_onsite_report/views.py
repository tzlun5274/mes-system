...
class OnsiteReportIndexView(LoginRequiredMixin, TemplateView):
    ...
    template_name = "workorder/workorder_onsite_report/index.html"
...
class OnsiteReportListView(LoginRequiredMixin, ListView):
    ...
    model = OnsiteReport
    template_name = "workorder/workorder_onsite_report/onsite_report_list.html"
...
def operator_onsite_report_create(request):
    ...
    return render(request, 'workorder/workorder_onsite_report/operator_onsite_report_form.html', context)
...
class OnsiteReportDetailView(LoginRequiredMixin, DetailView):
    ...
    model = OnsiteReport
    template_name = "workorder/workorder_onsite_report/onsite_report_detail.html"
...
class OnsiteReportDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = OnsiteReport
    template_name = "workorder/workorder_onsite_report/onsite_report_confirm_delete.html"
...
class OnsiteReportMonitoringView(LoginRequiredMixin, TemplateView):
    ...
    template_name = "workorder/workorder_onsite_report/onsite_report_monitoring.html"
...
class OnsiteReportConfigView(LoginRequiredMixin, ListView):
    ...
    template_name = "workorder/workorder_onsite_report/onsite_report_config.html"
...
class OnsiteReportConfigDeleteView(LoginRequiredMixin, DeleteView):
    ...
    model = OnsiteReportConfig
    template_name = "workorder/workorder_onsite_report/onsite_report_config_confirm_delete.html"
...
def operator_work_selection(request):
    """作業員報工作業選擇頁面"""
    return render(request, 'workorder/workorder_onsite_report/operator_work_selection.html', {
        'title': '作業員現場報工作業選擇',
...
def smt_work_selection(request):
    """SMT報工作業選擇頁面"""
    return render(request, 'workorder/workorder_onsite_report/smt_work_selection.html', {
        'title': 'SMT現場報工作業選擇',
...
def smt_onsite_report_create(request):
    ...
    return render(request, 'workorder/workorder_onsite_report/smt_onsite_report_form.html', context)
...
def onsite_report_update(request, pk):
    ...
    return render(request, 'workorder/workorder_onsite_report/onsite_report_edit.html', context)
...
def onsite_report_config_create(request):
    ...
    return render(request, 'workorder/workorder_onsite_report/onsite_report_config_form.html', context)
...
def operator_rd_onsite_report_create(request):
    ...
    return render(request, 'workorder/workorder_onsite_report/operator_rd_onsite_report_form.html', context)
...
def smt_rd_onsite_report_create(request):
    ...
    return render(request, 'workorder/workorder_onsite_report/smt_rd_onsite_report_form.html', context)
...
def rd_sample_workorder_list(request):
    ...
    return render(request, 'workorder/workorder_onsite_report/rd_sample_workorder_list.html', context)
...
def rd_sample_workorder_detail(request, pk):
    ...
    return render(request, 'workorder/workorder_onsite_report/rd_sample_workorder_detail.html', context)
...
def rd_sample_workorder_delete(request, pk):
    ...
    return render(request, 'workorder/workorder_onsite_report/rd_sample_workorder_delete.html', context)
...
def rd_sample_workorder_create(request):
    ...
    return render(request, 'workorder/workorder_onsite_report/rd_sample_workorder_create.html', context) 