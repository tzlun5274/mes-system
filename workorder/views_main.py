...
def operator_supplement_template(request):
    ...
    try:
        ...
        # 添加範例資料 - 使用新格式
        example_data = [
            ['張小明', '10', '2025-01-15', '08:00', '12:00', 'WO-10-202501001', 'PROD-001', 'SMT', 'SMT-001', 100, 2, '正常生產', ''],
            ['李小華', '10', '2025/01/15', '13:00', '17:00', 'WO-10-202501001', 'PROD-001', 'DIP', 'DIP-001', 95, 5, '設備調整', '設備故障30分鐘'],
