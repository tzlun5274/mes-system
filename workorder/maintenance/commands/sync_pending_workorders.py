...
class Command(BaseCommand):
    help = "自動同步各公司生產製造命令到 CompanyOrder 表"
        ...
        for company in companies:
            ...
            try:
                ...
                workorder_logger.info(
                    f"公司 {company.company_name} 手動同步生產製造命令完成，新增 {company_synced} 筆記錄。"
                )
                ...
                workorder_logger.error(
                    f"公司 {company.company_name} 手動同步生產製造命令失敗：{e}"
                )

        self.stdout.write(
            self.style.SUCCESS(
                f"所有公司同步完成，共新增 {total_synced} 筆公司生產製造命令記錄"
            )
        )
        workorder_logger.info(
            f"所有公司手動同步生產製造命令完成，共新增 {total_synced} 筆公司生產製造命令記錄。"
        )
