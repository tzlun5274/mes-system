    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board_type', models.CharField(choices=[('production', '生產看板'), ('equipment', '設備看板'), ('quality', '品質看板'), ('material', '物料看板')], default='production', max_length=20, verbose_name='看板類型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('running', '運行中'), ('stopped', '停機'), ('fault', '故障')], max_length=20, verbose_name='狀態')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('todo', '待處理'), ('in_progress', '進行中'), ('completed', '已完成'), ('cancelled', '已取消')], default='todo', max_length=20, verbose_name='狀態')),
                ('priority', models.CharField(choices=[('low', '低'), ('medium', '中'), ('high', '高'), ('urgent', '緊急')], default='medium', max_length=10, verbose_name='優先級')),
                ('assigned_to', models.CharField(blank=True, max_length=100, null=True, verbose_name='負責人')),
